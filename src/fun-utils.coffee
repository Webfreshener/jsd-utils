...
_scope.wfUtils.Fun.getFunctionName = (fun)->
...
_scope.wfUtils.Fun.getConstructorName = (fun)->
...
_scope.wfUtils.Fun.construct = (constructor, args)->
...
_scope.wfUtils.Fun.fromString = (string)->
...
_scope.wfUtils.Fun.toString = (fun)->
